...
export default function About() {
  return (
    <section
      id="about"
      className="py-12 md:py-20 bg-darkBg text-white px-6 md:px-20 border-t border-white/5 relative overflow-hidden"
    >
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
          <motion.div
            ...
            className="space-y-4 md:space-y-6 text-gray-400 leading-relaxed text-sm md:text-base"
          >
            <p>
          ...
          <motion.div
            ...
            className="space-y-6"
          >
            <div className="p-5 md:p-6 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm">
              ...
              <div className="space-y-6">
                <div className="relative pl-6 before:absolute before:left-0 before:top-2 before:w-2 before:h-2 before:bg-neonPurple before:rounded-full">
                  ...
                  <span className="text-[10px] md:text-xs text-neonBlue mt-1 inline-block">
                    2025 - Present
                  </span>
                </div>
                <div className="relative pl-6 before:absolute before:left-0 before:top-2 before:w-2 before:h-2 before:bg-neonPurple before:rounded-full">
